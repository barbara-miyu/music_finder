...
ActiveRecord::Schema.define(version: 2021_07_26_112603) do
  ...
  create_table "song_types", force: :cascade do |t|
    ...
    t.index ["type_id"], name: "index_song_types_on_type_id"
  end
  ...
  create_table "songanswers", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_songanswers_on_user_id"
  end

  create_table "songquestions", force: :cascade do |t|
    t.text "content"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "user_id"
  ...
  add_foreign_key "post_tags", "songs"
  add_foreign_key "post_tags", "tags"
  add_foreign_key "song_types", "songs"
  add_foreign_key "song_types", "types"
  add_foreign_key "songanswers", "songquestions"
  add_foreign_key "songanswers", "users"
end
